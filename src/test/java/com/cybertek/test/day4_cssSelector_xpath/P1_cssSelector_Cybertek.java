package com.cybertek.test.day4_cssSelector_xpath;
...
public class P1_cssSelector_Cybertek {
    ...
    public static void main(String[] args) {
       ...
       // WebElement homeLink = driver.findElement(By.cssSelector("a.nav-link"));
        ...
        WebElement powerdByText = driver.findElement(By.cssSelector("div[style='text-align: center;']"));
        ...
        System.out.println("powerdByText.isDisplayed() = " + powerdByText.isDisplayed());
    }
}